...
FloydWarshall floydWarshall = new FloydWarshall(); //initialize

public Node GraphMedian(Set<Node> nodeSet) {
...
public Node GraphCenter(Set<Node> nodeSet) {
