[[rest-api-rollback-an-open-transaction]]
...
include::includes/rollback-an-open-transaction.request.asciidoc[]

_Example response_

include::includes/rollback-an-open-transaction.response.asciidoc[]
