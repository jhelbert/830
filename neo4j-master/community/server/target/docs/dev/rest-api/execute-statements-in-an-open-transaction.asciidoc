[[rest-api-execute-statements-in-an-open-transaction]]
...
include::includes/execute-statements-in-an-open-transaction.request.asciidoc[]

_Example response_

include::includes/execute-statements-in-an-open-transaction.response.asciidoc[]
