[[rest-api-commit-an-open-transaction]]
...
include::includes/commit-an-open-transaction.request.asciidoc[]

_Example response_

include::includes/commit-an-open-transaction.response.asciidoc[]
